...
export function prefixFromSample(sample) {
  // \u00A0 and \u202F are written as escapes, not as the characters themselves.
  // They were literal invisible spaces in this class - a non-breaking space and a
  // narrow no-break space, both of which turn up inside figures lifted out of a
  // PDF. Invisible in the source, they were one careless keystroke from being
  // deleted by someone who could not see they were there, which would leave those
  // separators in a masked figure.
