...
export function createDataExport(ctx) {
  ...
  async function doExportHistory() {
    ...
    const bundle = {
      ...
      refundIncomeIds: state.refundIncomeIds || [],
  ...
  async function doImportHistory(e) {
    ...
    const nextConfirmedIncomeIds = [
      ...new Set([...(state.confirmedIncomeIds || []), ...(lr.confirmedIncomeIds || [])]),
    ];
    const nextRefundIncomeIds = [
      ...new Set([...(state.refundIncomeIds || []), ...(lr.refundIncomeIds || [])]),
    ];
    ...
    const nextPlanSetAside = [
      ...new Set([...(state._planSetAside || []), ...(planning.setAside || [])]),
    ];
    ...
    await Store.restoreSnapshot({
      ...
      meta: {
        ...
        bankConfirmedIncomeIds: nextConfirmedIncomeIds,
        bankRefundIncomeIds: nextRefundIncomeIds,
    ...
    state.confirmedIncomeIds = nextConfirmedIncomeIds;
    state.refundIncomeIds = nextRefundIncomeIds;
    ...
    state._planSetAside = nextPlanSetAside;
