...
const encrypted = await exportHistory(
  ...
  'correct horse battery staple',
  {
    ...
    confirmedIncomeIds: ['bank-income-1'],
    refundIncomeIds: ['bank-refund-1'],
    sharedAccounts: ['1111'],
...
note(restored.ledgerRules.confirmedIncomeIds[0] === 'bank-income-1', 'income confirmations round-trip');
note(restored.ledgerRules.refundIncomeIds[0] === 'bank-refund-1', 'refund confirmations round-trip');
...
note(restored.planning.setAside[0] === 'emergency', 'set-aside choices round-trip');
