...
note(/movement \? movementRead\(movement, prose\) : performanceRead\(snap\)/.test(investmentsUi), 'the cost read is the headline only when there is no movement to show');
note(/holdingsDetail\(snap, prose, movement \? performanceRead\(snap\) : null\)/.test(investmentsUi), 'and otherwise it stays available in the detail');
