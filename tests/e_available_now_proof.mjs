...
const complete = {
  ...
  lead: {
    ...
    tone: 'good',
    detail:
      'Your plan allocates 20% of a normal month to discretionary spending, applied to what is left after commitments.',
  },
  working: [
    {
      id: 'availableBalance',
  ...
  working: [
    {
      ...
      amount: 300000,
      amountText: '$300,000.00',
      tag: 'no scheduled payments before payday',
      tone: 'neutral',
      detail: '',
    },
  ],
...
// incomplete case is labelled - only the selectors follow the component.
{
  ...
  note(/Payments due before payday/.test(t), 'working item 2 label present');
